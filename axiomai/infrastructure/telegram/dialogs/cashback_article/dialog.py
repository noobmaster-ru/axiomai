...
⚠️ <b>Важно:</b> оставьте отзыв <b>БЕЗ</b> текста — только звёзды, без описания!
{% else %}
⚠️ <b>Важно:</b> оставьте отзыв <b>БЕЗ</b> фото и <b>БЕЗ</b> видео, а также <b>БЕЗ</b> упоминания товара!
{% endif %}
"""
